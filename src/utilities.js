...
export function  dateFormat(unix, offset, formatedDate = 'complete')  {
	...
	if  (formatedDate === 'currentDay') {
		return dayOfWeek
	}

	console.log(date)
	// return the full date
	return `${dayOfWeek}, ${dayOfMonth}${dateSuffix} ${month} '${year}`;
	
}

// conver UTC string time format
export function timeFormat (unix, offset, formatedTime = 'complete') {
	const date = fromUnixTime(unix + offset).toUTCString();
	let timeSuffix
